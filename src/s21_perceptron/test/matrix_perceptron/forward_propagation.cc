...
TEST(MatrixPerceptron, ForwardPropagation_where_3_2_2_1) {
...
TEST(MatrixPerceptron, ForwardPropagation_where_3_32_128_4) {
  ...
  auto exp = Matrix(1, 4, new float[4]{512.583923f, 486.220032f, 471.837891f, 494.315247f});
